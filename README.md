...
## Profile
Software engineer with **10+ years in safety-critical software** who has
progressively moved from hands-on development into **leading safety, RAMS and
verification**. Rare **multi-domain safety fluency** — has shipped under
**aviation (ED-153/ESARR4/SWAL), railway (CENELEC EN 5012x/SIL) and automotive
...
## Core competencies
- **Safety & assurance:** Functional Safety, RAMS, Hazard Analysis, Safety Cases,
  Technical Safety Reports, safe/non-safe function partitioning, audit liaison.
- **Standards:** ISO 26262 (ASIL) · CENELEC EN 50126/50128/50129/50159 (SIL) ·
  ED-153 · ESARR 4 · ICAO Doc 9859 (SMS) · EU 2017/373 · SWAL 3/4.
- **Leadership:** RAMS/verification management of 50+-person multi-site teams;
  cross-country safety coordination (DE/AT/NL/IE/RO); process improvement.
- **Engineering:** Python, C++ (C++14), C (embedded/VxWorks); BDD/Squish/Selenium
  test-automation; IBM Rhapsody (UML/SysML); Git, Jenkins, Jira, Docker, QEMU,
  Yocto/Bitbake, Qt.
- **AI-assisted development:** intensive Claude user; agentic/LLM-assisted
  workflows for test generation, requirement & verification-report drafting, code
...
- **IATA — Human Factors in Aviation** — passed with distinction (Geneva, 2024)
- **Safety Management System for Civil Aviation (SMS)**
- **Perception of a Safety Culture from a Leadership Perspective**
